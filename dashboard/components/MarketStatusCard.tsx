...
function tone(regime: string, marketMode?: string) {
    const r = regime.toUpperCase();
    const m = (marketMode ?? "").toUpperCase();
    ...
    if (r.includes("NO_TRADE") || m.includes("NO_TRADE")) return "gray";
    return "blue";
}
...
export default function MarketStatusCard({
    ...
    const t = tone(regime, marketMode);
