export const D8_POINT_IN_TIME_SNAPSHOT_SCHEMA_VERSION = 1;
...
export interface D8PointInTimeSnapshot {
  schemaVersion: typeof D8_POINT_IN_TIME_SNAPSHOT_SCHEMA_VERSION;
...
export function validateD8PointInTimeSnapshot(
  ...
  if ("schemaVersion" in row && row.schemaVersion !== D8_POINT_IN_TIME_SNAPSHOT_SCHEMA_VERSION) {
    errors.push("schema_version_must_be_1");
  }
